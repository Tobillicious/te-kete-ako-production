#!/usr/bin/env python3
"""
Batch 200 Indexer - Process Next 50 Critical MD Files
Continues systematic GraphRAG indexing with the next high-priority batch

Current Status: 879 entries (62.3% coverage)
Target: Process next 50 files to reach ~66% coverage
Remaining: 1,212 files (37.7% gap)
"""
...
def get_next_50_files():
    """Get the next 50 MD files to process (files 201-250)"""
    ...
    return all_md_files[200:250]  # Next 50 files (201-250)
...
def main():
    ...
    print("📦 BATCH 200 INDEXER - Continue Knowledge Gap Closure")
    print("=" * 60)
    ...
    with open('batch_200_insertions.sql', 'w', encoding='utf-8') as f:
        f.write('\n'.join(sql_statements))

    print("\n📄 SQL file created: batch_200_insertions.sql")
