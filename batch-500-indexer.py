#!/usr/bin/env python3
"""
Batch 500 Indexer - Continue Systematic GraphRAG Knowledge Base Expansion
Process next 50 high-priority MD files to continue closing the knowledge gap

Current Status: 1,029 entries (72.9% coverage)
Target: Process next 50 files to reach ~76% coverage
Remaining: 1,112 files (27.1% gap)
"""
...
def get_next_50_files():
    """Get the next 50 MD files to process (files 501-550)"""
    ...
    return all_md_files[500:550]  # Next 50 files (501-550)
...
def main():
    ...
    print("📦 BATCH 500 INDEXER - Continue Knowledge Gap Closure")
    print("=" * 60)
    ...
    with open('batch_500_insertions.sql', 'w', encoding='utf-8') as f:
        f.write('\n'.join(sql_statements))

    print("\n📄 SQL file created: batch_500_insertions.sql")
