#!/usr/bin/env python3
"""
Batch 300 Indexer - Continue Systematic GraphRAG Knowledge Base Expansion
Process next 50 high-priority MD files to continue closing the knowledge gap

Current Status: 929 entries (65.8% coverage)
Target: Process next 50 files to reach ~69% coverage
Remaining: 1,212 files (34.2% gap)
"""
...
def get_next_50_files():
    """Get the next 50 MD files to process (files 301-350)"""
    ...
    return all_md_files[300:350]  # Next 50 files (301-350)
...
def main():
    ...
    print("📦 BATCH 300 INDEXER - Continue Knowledge Gap Closure")
    print("=" * 60)
    ...
    with open('batch_300_insertions.sql', 'w', encoding='utf-8') as f:
        f.write('\n'.join(sql_statements))

    print("\n📄 SQL file created: batch_300_insertions.sql")
