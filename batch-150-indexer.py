#!/usr/bin/env python3
"""
Batch 150 Indexer - Continue Systematic GraphRAG Knowledge Base Expansion
Process next 50 high-priority MD files to continue closing the knowledge gap

Current Status: 825 entries (58.4% coverage)
Target: Process next 50 files to reach ~62% coverage
Remaining: 1,262 files (41.6% gap)
"""
...
def get_next_50_files():
    """Get the next 50 MD files to process (files 151-200)"""
    ...
    return all_md_files[150:200]  # Next 50 files (151-200)
...
def main():
    ...
    print("📦 BATCH 150 INDEXER - Continue Knowledge Gap Closure")
    print("=" * 60)
    ...
    with open('batch_150_insertions.sql', 'w', encoding='utf-8') as f:
        f.write('\n'.join(sql_statements))

    print("\n📄 SQL file created: batch_150_insertions.sql")
