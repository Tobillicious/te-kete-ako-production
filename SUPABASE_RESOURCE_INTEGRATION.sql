-- Te Kete Ako - Comprehensive Resource Integration for Supabase
-- Adding all discovered "forgotten" resources to the resources table
...
'{"achievement_objectives": ["Cross-curricular engagement and motivation"], "curriculum_areas": ["All"], "key_competencies": ["Managing self", "Participating and contributing"]}',
'{"maori_concepts": ["progression from Tamaiti to Kaiako"], "cultural_integration": "high", "te_reo_usage": "high", "cultural_levels": true}',
'intermediate',
30,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Te Reo Māori levels 1-4: Communicate in te reo Māori", "Social Sciences: Cultural identity and heritage"], "curriculum_areas": ["Te Reo Māori", "Social Sciences"], "key_competencies": ["Using language, symbols, and texts", "Relating to others"]}',
'{"maori_concepts": ["purakau", "whakapapa", "cultural narratives"], "cultural_integration": "essential", "te_reo_usage": "immersive", "cultural_validation": "kaumatua_involved"}',
'advanced',
45,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Social Sciences Level 4: Identity, culture, and organisation", "Te Ao Māori: Whakapapa connections"], "curriculum_areas": ["Social Sciences", "Te Ao Māori"], "key_competencies": ["Relating to others", "Participating and contributing"]}',
'{"maori_concepts": ["whakapapa", "whakatohea", "manaakitanga", "kaitiakitanga"], "cultural_integration": "essential", "te_reo_usage": "high", "community_involvement": true}',
'advanced',
960,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Te Ao Māori: Cultural protocols and practices", "Social Sciences: Participation in cultural contexts"], "curriculum_areas": ["Te Ao Māori", "Social Sciences"], "key_competencies": ["Relating to others", "Participating and contributing"]}',
'{"maori_concepts": ["marae protocol", "powhiri", "hongi", "karakia"], "cultural_integration": "essential", "te_reo_usage": "immersive", "real_world_preparation": true}',
'advanced',
120,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Social Studies Level 4: How systems shape lives"], "curriculum_areas": ["Social Sciences"], "key_competencies": ["Relating to others", "Participating and contributing"]}',
'{"maori_concepts": ["kotahitanga", "whakatohea"], "cultural_integration": "high", "te_reo_usage": "moderate"}',
'intermediate',
300,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Social Studies Level 4: Systems and structures"], "curriculum_areas": ["Social Sciences"], "key_competencies": ["Thinking", "Participating and contributing"]}',
'{"maori_concepts": ["holistic assessment"], "cultural_integration": "high", "te_reo_usage": "moderate"}',
'intermediate',
30,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Social Studies Level 4: Different perspectives and values"], "curriculum_areas": ["Social Sciences"], "key_competencies": ["Thinking", "Relating to others"]}',
'{"maori_concepts": ["whakapapa", "mana", "kaitiakitanga", "kotahitanga", "utu"], "cultural_integration": "essential", "te_reo_usage": "high", "indigenous_framework": true}',
'advanced',
60,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Social Studies Level 4: Systems and organization"], "curriculum_areas": ["Social Sciences"], "key_competencies": ["Thinking", "Managing self"]}',
'{"cultural_integration": "moderate", "te_reo_usage": "low"}',
'intermediate',
45,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Cross-curricular culturally responsive assessment"], "curriculum_areas": ["All"], "key_competencies": ["All"]}',
'{"maori_concepts": ["whakatohea", "whakapapa", "manaakitanga", "mauri-ora"], "cultural_integration": "essential", "te_reo_usage": "high", "assessment_philosophy": "revolutionary"}',
'advanced',
90,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Professional teaching standards"], "curriculum_areas": ["All"], "key_competencies": ["Professional development"]}',
'{"cultural_integration": "framework_provided", "te_reo_usage": "guided", "cultural_guidance": true}',
'intermediate',
30,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Social Studies Level 4: Systems design and analysis"], "curriculum_areas": ["Social Sciences"], "key_competencies": ["Thinking", "Using language, symbols, and texts"]}',
'{"cultural_integration": "moderate", "te_reo_usage": "moderate"}',
'intermediate',
75,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Social Studies Level 4: Inquiry and critical thinking"], "curriculum_areas": ["Social Sciences"], "key_competencies": ["Thinking", "Participating and contributing", "Relating to others"]}',
'{"maori_concepts": ["ropu work", "collective decision-making"], "cultural_integration": "high", "te_reo_usage": "moderate"}',
'advanced',
1500,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Social Studies Level 4: How people organize themselves", "Social Studies Level 4: How systems operate"], "curriculum_areas": ["Social Sciences"], "key_competencies": ["Thinking", "Participating and contributing", "Relating to others"]}',
'{"maori_concepts": ["tino rangatiratanga", "mana", "governance systems"], "cultural_integration": "essential", "te_reo_usage": "high", "decolonized_approach": true}',
'advanced',
1500,
'Te Kete Ako Team'),
...
'{"achievement_objectives": ["Social Studies Level 4: How societies are organized"], "curriculum_areas": ["Social Sciences"], "key_competencies": ["Thinking", "Participating and contributing"]}',
'{"cultural_integration": "high", "te_reo_usage": "moderate", "values_based": true}',
'advanced',
1800,
'Te Kete Ako Team');

-- Create indexes for the new resources
CREATE INDEX IF NOT EXISTS idx_resources_featured_priority ON resources(featured, type, subject) WHERE featured = true;
CREATE INDEX IF NOT EXISTS idx_resources_cultural_integration ON resources USING GIN((cultural_elements->'cultural_integration'));
