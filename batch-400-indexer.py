#!/usr/bin/env python3
"""
Batch 400 Indexer - Continue Systematic GraphRAG Knowledge Base Expansion
Process next 50 high-priority MD files to continue closing the knowledge gap

Current Status: 979 entries (69.4% coverage)
Target: Process next 50 files to reach ~73% coverage
Remaining: 1,162 files (30.6% gap)
"""
...
def get_next_50_files():
    """Get the next 50 MD files to process (files 401-450)"""
    ...
    return all_md_files[400:450]  # Next 50 files (401-450)
...
def main():
    ...
    print("📦 BATCH 400 INDEXER - Continue Knowledge Gap Closure")
    print("=" * 60)
    ...
    with open('batch_400_insertions.sql', 'w', encoding='utf-8') as f:
        f.write('\n'.join(sql_statements))

    print("\n📄 SQL file created: batch_400_insertions.sql")
